...
class AlternativRegister implements IRegister {
  ...
  AlternativRegister({List<int>? coins, List<int>? payout, bool? adminMode, int? debit, String? message, int? price, int? producedSlot, int? selectedSlot})
      : _coins = coins ?? <int>[],
        _payout = payout ?? <int>[],
